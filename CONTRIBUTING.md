...
issues ouvertes : rate limiting partagé entre plusieurs instances (aujourd'hui en mémoire par
processus), rejeu de monitoring sur historique, couverture de tests à 90 % (74 % aujourd'hui,
seuil CI à 70 %).
